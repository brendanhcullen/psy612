...
-   The data is stored in a dataframe called `health` and has been pre-loaded for you. You cam get a glimpse of the data below. 
...
$$\hat{health}_{i} = 1.6569733 + 0.4904059 * consc_{i}$$ <br>
...
-   Fill in the blanks in the code to create a plot of the prediction band for our model. Pay special attention to `lwr` and `upr` within `pred_plot_data` above. How will you incorporate these variables into the plot?
